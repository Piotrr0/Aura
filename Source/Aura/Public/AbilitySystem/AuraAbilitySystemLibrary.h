...
public:
	...
	static int32 GetXPRewardForClassAndLevel(const UObject* WorldContextObject, const ECharacterClass& CharacterClass, int32 CharacterLevel);
	...
	UFUNCTION(BlueprintCallable, Category = "AuraAbilitySystemLibrary|GameplayMechanics")
	static bool StickToGroundLocation(const UObject* WorldContextObject, const FVector& Location, FVector& OutGroundLocation, float Offset = 0);
};
